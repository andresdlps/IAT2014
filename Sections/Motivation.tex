...
\todo[inline]{It is missing a paragraph explaining how all this theory is related in the architecture}
...
When a potential goal satisfies its preconditions the goal becomes an active goal. At this point, the agent check if exists the abilities and resources needed to complete the goal. If not, the goal remains as a potential goal. If there is enough tools and resources the goal becomes a viable goal. \todo[inline]{how is this done?} 
